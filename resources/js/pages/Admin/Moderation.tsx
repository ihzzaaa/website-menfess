...
export default function Moderation({ status }: ModerationProps) {
    ...
    const menuItems = [
        ...
        { icon: '💬', label: 'Moderation', path: '/admin/moderation', active: true },
                ...
                <main className="flex-1 p-8">
                    ...
                    <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-12 border-2 border-cyan-200/50 shadow-lg text-center min-h-96 flex items-center justify-center">
                        <div>
                            ...
                            <h2 className="text-3xl font-bold text-cyan-700 mb-2">Content Moderation</h2>
                            <p className="text-cyan-600 font-semibold">Halaman untuk moderasi konten akan diisi di sini</p>
                        </div>
                    </div>
                </main>
            </div>
